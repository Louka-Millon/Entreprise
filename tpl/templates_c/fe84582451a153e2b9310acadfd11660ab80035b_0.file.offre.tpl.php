<?php
/* Smarty version 3.1.39, created on 2021-04-01 00:19:42
  from 'C:\xampp\htdocs\Entreprise\tpl\pages\offre.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_6064f57e565687_56569574',
...
function content_6064f57e565687_56569574 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 / 5 : Number of votes : <?php echo $_smarty_tpl->tpl_vars['moyenneetudiant']->value['compte'];?>
</span>
...
"><input type="number" name="noteeleve" min="0" max="5" value="0"><input type="submit" value="Vote"></form>
                <?php }?>
                <?php }?>
                <p>Tutors rating :</p>

                <span><?php echo sprintf("%.1f",$_smarty_tpl->tpl_vars['moyennetuteur']->value['moyenne']);?>
 / 5 : Number of votes : <?php echo $_smarty_tpl->tpl_vars['moyennetuteur']->value['compte'];?>
</span>
...
"><input type="number" name="notepilote" min="0" max="5" value="0"><input type="submit" value="Vote"></form>
                <?php }?>
                <?php }?>
            ...
            <div class="offre-row details">
                <div class="details-texte">
                    ...
                    <p>Beginning of the offer : <?php echo $_smarty_tpl->tpl_vars['entreprisebyname']->value['date_offre'];?>
</p>
                    <p>Duration of the offer : <?php echo $_smarty_tpl->tpl_vars['entreprisebyname']->value['duree_offre'];?>
 week(s)</p>
                    <p>Remuneration : <?php echo $_smarty_tpl->tpl_vars['entreprisebyname']->value['remuneration'];?>
 €</p>
                </div>
...
"><button id="btn_wishlist">Add to wishlist</button></a>
